...
@SpringFunctionality(app = FenixeduUlisboaSpecificationsController.class, title = "label.title.shiftsEnrolmentFacade")
@RequestMapping("shiftsEnrolmentFacade")
public class ShiftEnrolmentFacade {
    @RequestMapping
    public String doRedirect(HttpServletRequest request) {
        String link = "/student/studentShiftEnrollmentManager.do?method=prepare";
